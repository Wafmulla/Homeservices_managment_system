 ...
 $contact="";
  ...
  if($_SERVER["REQUEST_METHOD"]=="POST")
  {
    ...
    if($num==0){
      ...
      $sql="Select password from helper where contact='$contact'";
     ...
     $row=mysqli_fetch_assoc($result1);
      if($password!=$row['password']){
        ...
        echo "<script>
        window.location.assign('helperprofile.php');
         </script>";
      }
    }
  ...
  if($emailerror){
    echo ' <div class="alert alert-danger 
      ...
      <strong class="error-msg">Error!</strong> <span  class="error-msg">"Contact does not exist.Please sign up"</span>
  ...
  <div class="container">
    <form class="login-form " action="" method="post">
      <h1>Login</h1>
      <input type="text" placeholder="Contact Number" name="contact" value="<?=$contact?>" required>
